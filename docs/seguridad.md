...
- Llamadas a Gemini desde navegador: el análisis de imágenes llama a la API de IA directamente desde el cliente. Esto expone claves, consumo y coste potencial a cualquier usuario capaz de inspeccionar la app.
