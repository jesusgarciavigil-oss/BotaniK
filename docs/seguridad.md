...
- Posible riesgo de XSS por uso de `innerHTML`: varias partes de la interfaz construyen HTML con datos que pueden venir de Firestore o de entradas de usuario. Ya se ha iniciado una reducción progresiva en avatares, buzón, selectores sencillos, perfiles, dropdown de perfiles y cromos del álbum, pero siguen pendientes zonas dinámicas más complejas como panel admin y plantillas generadas.
