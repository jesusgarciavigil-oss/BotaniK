...
- Mantener el panel admin deshabilitado mientras no exista autorización real.
...
- [ ] Confirmar que el panel admin sigue deshabilitado si todavía no hay Auth/reglas/backend.
...
- [ ] Confirmar que el panel admin no se reactiva sin autorización real.
